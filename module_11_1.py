...
# Функция отображения прошедшего времени в формате Ч:ММ:СС.%%%%%%
def time_convert(start, end):
    dur = end - start
    return (f'{time.strftime("%H:%M:%S", time.gmtime(dur))}.{str((dur - int(dur)) * 1000000)[0:5]}')
...
#     read_info(filename)
# end_time = time.time()
# print(time_convert(start_time, end_time), '(линейный)')
...
if __name__ == '__main__':
    ...
    end_time = time.time()
    print(time_convert(start_time, end_time), '(многопроцессный)')
